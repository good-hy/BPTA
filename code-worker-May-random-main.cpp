...
int main(int argc, char const *argv[])
{

    {
        ...
        else if (dataOption == 2)
        {
            ...
            Number_Task = 2000;
            Number_Worker = 50;
            int ntask1[6] = {25, 50, 100, 200, 450, 700};
        ...
        {
            for (int algorithmOption = 0; algorithmOption <= 3; algorithmOption++)
            {
                for (int test_taskNum = 1; test_taskNum <= 1; test_taskNum++)
                {
                    for (int test_workerNum = 0; test_workerNum <= 3; test_workerNum++)
                    {
                            ...
                            for (int test_Capacity = 1; test_Capacity <= 1; test_Capacity++)
                            {
                                for (int test_Tmax = 1; test_Tmax <= 1; test_Tmax++)
                                {
                                    for (int test_Wmax = 1; test_Wmax <= 1; test_Wmax++)
                                    {
                                        ...
                                        Basic_information info(c, speed, Number_Task * test_taskNum, nworker[test_workerNum], Capacity * test_Capacity, Wmax * test_Wmax, Tmax * test_Tmax, sati_state, dataOption);
                                        ...
                                        for (int repeat_Num = 0; repeat_Num < 1; repeat_Num++)
                                        {
                                            ...
                                            if (dataset_state)
                                            {
                                                if (algorithmOption == 0)
                                                {
                                                    ...
                                                    info.printf_Satisfaction_Results_num(alg_name, duration.count(), test_rangeNum, test_taskNum, nworker[test_workerNum]);
                                                }
                                        ...
                                        cout << alg_name + "\t 工人：" << info.global_workers.size() << endl;
